...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { paddle_game_id: @score.paddle_game_id, score: @score.score } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { paddle_game_id: @score.paddle_game_id, score: @score.score } }
