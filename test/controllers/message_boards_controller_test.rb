...
class MessageBoardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create message_board" do
    assert_difference('MessageBoard.count') do
      post message_boards_url, params: { message_board: { message_id: @message_board.message_id } }
    end
  ...
  test "should update message_board" do
    patch message_board_url(@message_board), params: { message_board: { message_id: @message_board.message_id } }
